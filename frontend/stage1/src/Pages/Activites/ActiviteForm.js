  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <h3>
          Je suis disponible pour faire cette activté se déroulant la semaine du{" "}
          {semaine} le{" "}
        </h3>
        ...
        <div className="label-form">
          ...
          <select
            value={ma1}
            onChange={(e) => setMa1(parseInt(e.target.value))}
          >
            <option value={0}>Non</option>
            <option value={1}>Oui</option>
          </select>
        ...
        <div className="label-form">
          ...
          <select
            value={ma2}
            onChange={(e) => setMa2(parseInt(e.target.value))}
          >
            <option value={0}>Non</option>
            <option value={1}>Oui</option>
          </select>
        ...
        <div className="label-form">
          ...
          <select
            value={me1}
            onChange={(e) => setMe1(parseInt(e.target.value))}
          >
            <option value={0}>Non</option>
            <option value={1}>Oui</option>
          </select>
        ...
        <div className="label-form">
          ...
          <select
            value={me2}
            onChange={(e) => setMe2(parseInt(e.target.value))}
          >
            <option value={0}>Non</option>
            <option value={1}>Oui</option>
          </select>
      ...
      {userRole && userRole === "Admin" && <ActiviteFichier />}
    </div>
  );
}
