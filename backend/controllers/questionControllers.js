...
exports.getAllQuestions = async (req, res) => {
  try {
    ...
    res
      .status(404)
      .json({ message: "Error aucune question n'a été trouvée", error });
  }
};
...
exports.getQuestionsByQuestionnaire = async (req, res) => {
  ...
  try {
    const questions = await QuestionServices.getQuestionsByQuestionnaire(
      questionnaire
    );
    ...
    res
      .status(404)
      .json({
        message: "Error aucune question n'a été trouvée pour ce questionnaire",
        error,
      });
  }
};
...
exports.addQuestion = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Error impossible de rajouter une question", error });
  }
};
...
exports.updateQuestion = async (req, res) => {
  ...
  try {
    ...
    const questionUpdated = await QuestionServices.updateQuestion(
      questionId,
      questionData
    );
    ...
    res
      .status(500)
      .json({ message: "Impossible de mettre à jour cette question", error });
  }
};
...
exports.deleteQuestion = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Impossible de supprimer une question", error });
  }
};
